...
public class HtmlCleaner {
	//TODO be careful about how much HTML content is removed before links are parsed!
	// (sounds like an order of operations thing to me)
	...
	public static String stripElement(String html, String name) {
		String regex = String.format("(?i)<%s[\\s|>][\\s\\S]*?</%s[\\s]*?>", name, name);
